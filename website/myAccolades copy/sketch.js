...
function nmsDescript() {
  ...
  console.log(right + "  " + left + "  " + top + "  " + bottom);
  if(mouseX < 800 && mouseX > 550 && mouseY < 435 && mouseY > 67) {
    document.getElementById('nmsIcondDescript').style.display = 'inline';
    document.getElementById('awardIcon').style.display = 'none';
  }
  else {
    document.getElementById('nmsIcondDescript').style.display = 'none';
